# The identity plane as a published image.
#
...
RUN CGO_ENABLED=0 GOOS=${TARGETOS:-linux} GOARCH=${TARGETARCH:-amd64} \
    ...
    -o /out/service ./cmd/idryx

FROM gcr.io/distroless/static-debian12:nonroot
LABEL org.opencontainers.image.title="idryx"
LABEL org.opencontainers.image.description="Stitches humans, service accounts, keys and AI agents into one identity and access graph, then flags excessive privilege and anomalous behaviour."
LABEL org.opencontainers.image.source="https://github.com/TAIPANBOX/idryx"
